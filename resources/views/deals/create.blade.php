...
<div class="content-card">
    <div class="form-header">
        <h1 class="form-title">Create New Deals</h1>
        <div class="form-actions">
            <a href="{{ route('help.show', ['form' => 'deals.create']) }}" target="_blank" class="btn btn-secondary" title="Help" style="background: #757575; color: white; padding: 8px 12px; font-size: 16px; font-weight: bold;">?</a>
        </div>
    ...
    <form method="POST" action="{{ route('deals.store') }}">
        ...
        <div style="display: flex; gap: 10px;">
            <button type="submit" class="btn btn-primary">Create Deals</button>
