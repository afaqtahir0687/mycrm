...
<div class="content-card">
    <div class="form-header">
        <h1 class="form-title">Create New Quotations</h1>
        <div class="form-actions">
            <a href="{{ route('help.show', ['form' => 'quotations.create']) }}" target="_blank" class="btn btn-secondary" title="Help" style="background: #757575; color: white; padding: 8px 12px; font-size: 16px; font-weight: bold;">?</a>
        </div>
    ...
    <form method="POST" action="{{ route('quotations.store') }}" enctype="multipart/form-data">
        ...
        <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 20px; margin-bottom: 20px;">
            <div class="form-group">
                ...
                <input type="text" name="quotation_number" value="{{ old('quotation_number') }}" required>
            ...
            <div class="form-group">
                ...
                <select name="deal_id" class="form-control">
                    ...
                    @foreach($deals as $deal)
                        <option value="{{ $deal->id }}" {{ old('deal_id', $preSelected['deal_id'] ?? '') == $deal->id ? 'selected' : '' }}>{{ $deal->deal_name }}</option>
                    @endforeach
                </select>
                @error('deal_id')
                    <div class="error">{{ $message }}</div>
            ...
            <div class="form-group" style="grid-column: 1 / -1;">
                ...
                <textarea name="terms_conditions" rows="4">{{ old('terms_conditions') }}</textarea>
            ...
            <div class="form-group" style="grid-column: 1 / -1;">
                ...
                <small style="color: #666; font-size: 12px;">Upload agreement template document (Max 10MB)</small>
        ...
        <div style="display: flex; gap: 10px;">
            <button type="submit" class="btn btn-primary">Create Quotations</button>
