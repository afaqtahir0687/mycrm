...
<div class="content-card">
    <div class="form-header">
        ...
        <div class="form-actions">
            <a href="{{ route('help.show', ['form' => 'products.edit']) }}" target="_blank" class="btn btn-secondary" title="Help" style="background: #757575; color: white; padding: 8px 12px; font-size: 16px; font-weight: bold;">?</a>
        </div>
    ...
    <form method="POST" action="{{ route('products.update', $product) }}">
        ...
        <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 20px; margin-bottom: 20px;">
            ...
            <div class="form-group" style="grid-column: 1 / -1;">
                ...
                <textarea name="specifications" rows="3">{{ old('specifications', $product->specifications) }}</textarea>
